...
public class ReportViewModel extends AndroidViewModel {
    ...
    public LiveData<List<Report>> getAllReportsInDate(String date){ return reportDao.getAllReportInDate(date); }

    public LiveData<Report> getReport(int reportId){
        return reportDao.getReport(reportId);
    }

    public LiveData<Double> getAVGDaily(String value,String data){
