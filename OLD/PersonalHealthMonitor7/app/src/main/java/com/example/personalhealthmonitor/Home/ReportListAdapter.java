    ...
    public class ReportViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(Report report, int position) {
            ...
            if(report.getBattito() != 0){
                ...
                TextView TXVBattito = itemView.findViewById(R.id.TXVbattito);
                TXVBattito.setText("");
                itemView.findViewById(R.id.LLbattito).setVisibility(View.GONE);
            }
            if(report.getPressione_sistolica() != 0 || report.getPressione_diastolica() != 0){
                ...
                itemView.findViewById(R.id.LLpressione).setVisibility(View.GONE);
            }
            if(report.getTemperatura() != 0){
                ...
                itemView.findViewById(R.id.LLtemperatura).setVisibility(View.GONE);
            }
            if(report.getGlicemiamax() != 0 || report.getGlicemiamin() != 0){
                ...
                itemView.findViewById(R.id.LLglicemia).setVisibility(View.GONE);
            }
            if(!report.getNota().equals("")){
                ...
                TextView TXVNote = itemView.findViewById(R.id.TXVnote);
                TXVNote.setText("");
                itemView.findViewById(R.id.TXVnote).setVisibility(View.GONE);
            }
            mPosition = position;
        }
