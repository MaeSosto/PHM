...
public class StatisticheViewModel extends ViewModel {
    ...
    public LineData test1(String val){
        ArrayList<Entry> dataVals = new ArrayList<>();
        int i = 0;
        reportViewModel.getAllReports(val,inizio,fine).observeForever(new Observer<List<Report>>() {
            @Override
        ...
        //imposto 3 calendari con le date di inizio e di fine e uno che fa da perno
        Calendar calendarInizio = Calendar.getInstance();
        calendarInizio.setTime(inizio);
        Calendar calendarFine = Calendar.getInstance();
        calendarFine.setTime(fine);
        ...
        /*else {
            calendarGiorno.setTime(testReports.get(i).getGiorno());
            calendarInizio.setTime(testReports.get(i).getGiorno());
            calendarFine.setTime(testReports.get((.size())-1).getGiorno());
        }
         */
