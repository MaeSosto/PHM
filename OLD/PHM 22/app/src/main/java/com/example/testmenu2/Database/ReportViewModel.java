...
public class ReportViewModel extends AndroidViewModel {
    ...
    public LiveData<List<Report>> getAllReportsInDate(Long date){ return reportDao.getAllReportInDate(date); }
    ...
    public LiveData<Double> getAVGDaily(String value,Long data){
