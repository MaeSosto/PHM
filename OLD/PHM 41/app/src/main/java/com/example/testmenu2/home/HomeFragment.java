    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModel.getSGiorno().observe(getViewLifecycleOwner(), new Observer<Date>() {
            ...
            public void onChanged(Date s) {
                ...
                todayreportVal.setText("Report del "+Converters.DateToString(s));

                //CAMBIANO I VALORI MEDI
                LiveData<Double> battiti = reportViewModel.getAVGInDate("report_battito", s);
                ...
                LiveData<Double> pressioneSistolica = reportViewModel.getAVGInDate("report_pressione_sistolica", s);
                pressioneSistolica.observe(getViewLifecycleOwner(), new Observer<Double>() {
                    @Override
                    public void onChanged(Double aDouble) {
                        TXVPressioneSistolica.setText(nullValue(tronca(aDouble)));
                    }
                });


                LiveData<Double> pressioneDiastolica = reportViewModel.getAVGInDate("report_pressione_diastolica", s);
                pressioneDiastolica.observe(getViewLifecycleOwner(), new Observer<Double>() {
                    @Override
                    public void onChanged(Double aDouble) {
                        TXVPressioneDiastolica.setText(nullValue(tronca(aDouble)));
                    }
                });

                LiveData<Double> temperatura = reportViewModel.getAVGInDate("report_temperatura", s);
                ...
                LiveData<Double> glicemia = reportViewModel.getAVGInDate("report_glicemia", s);
                ...
                mReports = reportViewModel.getAllReports(null, s, null);
