...
public class ReportViewModel extends AndroidViewModel {
    ...
    public Integer getCountInDay(Date date){
        String query = "SELECT COUNT(*) FROM reports WHERE report_giorno = "+ date;
        Log.i("QUERY", query);
    ...
    public Date getMinMaxDateReport(String max, String val){
        String query = "SELECT "+ max +"(report_giorno) from reports WHERE "+ val+ " != 0";
        return reportDao.getMinMaxDateReport(new SimpleSQLiteQuery(query));
    }
