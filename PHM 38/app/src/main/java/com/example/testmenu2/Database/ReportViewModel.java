...
public class ReportViewModel extends AndroidViewModel {
    ...
    public LiveData<Double> getAVGInDate(String value, Date data){
        ...
        switch (value){
            ...
            case "PressioneSistolica": return reportDao.getAVGPressioneSistolicaInDate(data);
            case "PressioneDiastolica": return reportDao.getAVGPressioneDiastolciaInDate(data);
    ...
    public LiveData<List<AVG>> getAVGAll(String value){
        switch (value){
            ...
            case "PressioneSistolica": return reportDao.getAVGPressioneSistolicaAll();
            case "PressioneDiastolica": return reportDao.getAVGPressioneDiastolicaAll();
    ...
    public LiveData<List<AVG>> getAVGInPeriod(String value, Date date1, Date date2){
        switch (value){
            ...
            case "PressioneSistolica": return reportDao.getAVGPressioneSistolicaInPeriod(date1, date2);
            case "PressioneDiastolica": return reportDao.getAVGPressioneDiastolicaInPeriod(date1, date2);
