    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModel.getSGiorno().observe(getViewLifecycleOwner(), new Observer<Date>() {
            ...
            public void onChanged(Date s) {
                ...
                LiveData<Double> pressioneSistolica = reportViewModel.getAVGInDate("PressioneSistolica", s);
                ...
                LiveData<Double> pressioneDiastolica = reportViewModel.getAVGInDate("PressioneDiastolica", s);
