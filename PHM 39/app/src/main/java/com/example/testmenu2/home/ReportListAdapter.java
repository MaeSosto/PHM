...
public class ReportListAdapter extends RecyclerView.Adapter<ReportListAdapter.ReportViewHolder> {
    ...
    public class ReportViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView TXVGiorno, TXVBattito, TXVPressioneSistolica, TXVPressioneDiastolica, TXVTemperatura, TXVGlicemia, TXVNote;
        ...
        public ReportViewHolder(@NonNull View itemView) {
            ...
            TXVPressioneSistolica = itemView.findViewById(R.id.TXVpressioneSistolica);
            TXVPressioneDiastolica = itemView.findViewById(R.id.TXVpressioneDiastolica);
        ...
        public void setData(Report report, int position) {
            ...
            TXVPressioneSistolica.setText(nullValue(report.getPressione_sistolica()));
            TXVPressioneDiastolica.setText(nullValue(report.getPressione_diastolica()));
