...
public class Report {
    ...
    public Report(int id, String giorno, String ora, double battito, double temperatura, double pressione, double glicemia, String nota) {
        this.id = id;
        this.giorno = giorno;
        this.ora = ora;
    ...
    public void setGiorno(String data) {
        this.giorno = data;
    }
