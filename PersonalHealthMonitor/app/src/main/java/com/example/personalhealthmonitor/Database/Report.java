...
public class Report {
    ...
    public Report(int id, Date giorno, Date mese, Date anno, String ora, double battito, double temperatura, double pressione_sistolica, double pressione_diastolica, double glicemia, String nota) {
        this.id = id;
        this.giorno = giorno;
        this.mese = mese;
        this.anno = anno;
