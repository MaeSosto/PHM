package com.example.testmenu2.home.UI;
...
public class EditReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!= null){
            ...
            Log.i("Errore", "niente bundle");
        }

        reportViewModel = ViewModelProviders.of(this).get(ReportViewModel.class);
        report = reportViewModel.getReport(reportId);
        ...
        BTNEditReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(check2input()){
                    Report report = new Report(reportId, giorno, ora, battiti,temperatura,pressione,glicemia, nota);
        ...
        //SGiorno = java.text.DateFormat.getDateInstance(DateFormat.SHORT, Locale.ITALIAN).format(new Date());
    }
