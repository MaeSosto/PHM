...
import com.example.testmenu2.home.UI.NewReportActivity;
import com.example.testmenu2.home.UI.ReportListAdapter;
import com.example.testmenu2.home.Utilities.OnSwipeTouchListener;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        homeViewModel.getSGiorno().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
            public void onChanged(String s) {

                //CAMBIA LA DATA SCRITTA IN ALTO
                todayreportVal.setText(s);

                //CAMBIANO I VALORI MEDI
                LiveData<Double> battiti = reportViewModel.getAVGDaily("battito", s);
                ...
                LiveData<Double> pressione = reportViewModel.getAVGDaily("pressione", s);
                ...
                LiveData<Double> temperatura = reportViewModel.getAVGDaily("temperatura", s);
                ...
                LiveData<Double> glicemia = reportViewModel.getAVGDaily("glicemia", s);
