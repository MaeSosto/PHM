...
public class StatisticheViewModel extends ViewModel {
    ...
    public static final int[] MY_COLORS = {
            rgb("#2ecc71"), rgb("#f1c40f"), rgb("#e74c3c"), rgb("#3498db"), rgb("#800080")
    };
    ...
    public ArrayList<PieEntry> getDataValues(List<Report> reports){
        ...
        int battito = 0, pressione = 0, temperatura = 0, glicemia = 0, nota = 0;
        ...
        dataVals.add(new PieEntry(nota, "Note"));
