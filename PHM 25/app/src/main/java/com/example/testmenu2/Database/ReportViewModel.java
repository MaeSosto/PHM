...
public class ReportViewModel extends AndroidViewModel {
    ...
    public LiveData<List<Report>> getAllReportsInPeriod(Date date1, Date date2){
        return reportDao.getAllReportsInPeriod(/*Converters.StringToDate("04/11/2020")*/ date1, /*Converters.StringToDate("04/11/2020")*/ date2);
    }
    ...
    public LiveData<Double> getAVGDaily(String value, Date data){

        switch (value){
            case "battito": return reportDao.getAVGBattito(data);
            case "pressione": return reportDao.getAVGPressione(data);
            case "temperatura": return reportDao.getAVGTemperatura(data);
            case "glicemia": return reportDao.getAVGGlicemia(data);
        }
        return null;
    }
